...
function PairedComparisonPage(_reference, _condition1, _condition2, _pageManager, _pageTemplateRenderer, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _errorHandler, _language) {
  ...
  // this.audioFileLoader.addFile(this.condition1.getFilepath(), (function (_buffer, _stimulus) { _stimulus.setAudioBuffer(_buffer); }), this.condition1);
  // this.audioFileLoader.addFile(this.condition2.getFilepath(), (function (_buffer, _stimulus) { _stimulus.setAudioBuffer(_buffer); }), this.condition2);
...
PairedComparisonPage.prototype.init = function () {
  this.mushraAudioControl = new MushraAudioControl(this.audioContext, this.bufferSize, this.reference, [this.condition1, this.condition2], this.errorHandler, false, false, false);
...
PairedComparisonPage.prototype.render = function (_parent) {
  ...
  var radioChoice = $("<div id='radio-choice' data-role='controlgroup' data-type='horizontal'>\
    ...
    <label for='radio-choice-a'>Yes</label>\
    <input type='radio' name='radio-choice' id='radio-choice-b' value='b'>\
    <label for='radio-choice-b'>No</label>\
  </div>");
...
PairedComparisonPage.prototype.store = function () {
 ...
 choice.left_image = this.condition1.filepath.split('/')[lastIndexCondition1]
  choice.right_image = this.condition2.filepath.split('/')[lastIndexCondition2] 



  if (this.choice === "a"){choice.preferred_image='Yes'}
  else{choice.preferred_image='No'}
